...
var local_storage_data_source_service_1 = require("./local-storage-data-source.service");
var ExpensesService = /** @class */ (function () {
    ...
    ExpensesService = __decorate([
        core_1.Injectable(),
        __metadata("design:paramtypes", [local_storage_data_source_service_1.LocalStorageDataSourceService, local_storage_data_source_service_1.LocalStorageDataSourceService])
    ], ExpensesService);
